...
<body class="body-wrapper">
                ...
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg navbar-light navigation">
                        <a class="navbar-brand">
                            <img src="{{asset('assets/images/logo.png')}}" height="50px" width="150px">
                        </a>
                    </nav>
                </div>
            </div>
    ...
    <div class="col-lg-4 offset-lg-0 col-md-5 offset-md-1 col-sm-6 col-6">
        <div class="category-block">
            <div class="header">
                <img src="{{asset('assets/images/biru.png')}}" height="200px" width="200px">
            </div>
            <a href="{{url('/grass')}}"><button type="button" class="btn btn-success">Grass</button></a>
            <button type="button" class="btn btn-primary">Poison</button>
        </div>
    </div>
